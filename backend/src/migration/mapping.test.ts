...
const config: MigrationConfig = {
  ...
  clientColumns: { businessName:'Business', niche:'Niche', saleDate:'Sale', workStartDate:'Start', lifecycleStage:'Stage', dateChurned:'Churn' },
...
describe('Excel migration mapping',()=>{
  ...
  it('normalizes services invoices and onboarding without computed columns',()=>{
    const plan=buildMigrationPlan([{rowNumber:2,values:{Business:'Acme',Niche:'Dental',Sale:'2026-01-01',Start:'2026-01-05',Stage:'Active',SEO:'1,200','June Revenue':'1500','[AUTO] Months':99}}],[{rowNumber:2,values:{Business:'Acme',Delay:'N/A',Access:'Yes'}}],config);
  ...
  it('rejects duplicates and unmatched onboarding rows',()=>{
    const plan=buildMigrationPlan([
      {rowNumber:2,values:{Business:'Acme Inc',Niche:'Dental',Sale:'2026-01-01',Start:'2026-01-05'}},
      {rowNumber:3,values:{Business:' ACME INC ',Niche:'Dental',Sale:'2026-01-01',Start:'2026-01-05'}}
